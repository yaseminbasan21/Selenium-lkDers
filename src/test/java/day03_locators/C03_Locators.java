...
public class C03_Locators {
    ...
    public static void main(String[] args) {
        ...
        //b. Sign in butonuna basin
        WebElement signInLınk= driver.findElement(By.linkText("Sign in"));
        signInLınk.click();
        //c. email textbox,password textbox, and signin button elementlerini locate ediniz..
        ...
        // bir webElemtin uzerinde ne yazdigini gormek istersek webElementIsmi.getText() kullaniriz,(getText yapmadan sadece string'le bulmaya calısırsa bize referans verir)
        ...
        if(adressesElementi.isDisplayed()){             //isDisplayed() gorunuyor mu demek
